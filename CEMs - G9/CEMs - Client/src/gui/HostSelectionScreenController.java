...
public class HostSelectionScreenController implements Initializable 
{
	...
	void connect(ActionEvent event) throws IOException 
	{
		...
		if (IP.isEmpty())
			AlertMessages.makeAlertNoPlatform("You must enter server IP!", "Connect to Server");
		else 
		{
			...
			{
				AlertMessages.makeAlertNoPlatform("Couldn't connect to server.", "Connect to Server");
				System.exit(0);
			}
		}
	}
