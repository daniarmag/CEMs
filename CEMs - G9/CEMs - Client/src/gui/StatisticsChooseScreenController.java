...
public class StatisticsChooseScreenController implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources) 
	{
		...
		nameTXT.setText(user.get_fullName());
		idTXT.setText(user.getUser_id());
	...
	private void searchRow(ActionEvent e) 
	{
		...
		String searchField = searchBar.getText().trim().toLowerCase();
	...
	private boolean SearchUser(String searchField)
	{
		for (User item : ((TableView<User>) tableInfo).getItems()) {
			String name = item.getFirst_name().toLowerCase();
			String lastName = item.getLast_name().toLowerCase();
			String Id = item.getUser_id().toLowerCase();
