...
CREATE TABLE `question` (
  ...
  PRIMARY KEY (`question_number`,`id`,`subject_id`,`professor_id`),
...
INSERT INTO `question` VALUES (1,'011','01','1 + 1 = ?','Daniel Armaganian','209146943','2','1','2','3','4'),(2,'012','01','2 + 2 = ?','Matan Czuckermann','319003935','4','1','2','3','4'),(3,'023','02','What is the time complexity of merge sort algorithm?','Daniel Armaganian','209146943','O(nLogn)','O(Logn)','O(nLogn)','O(n^2)','O(n)'),(4,'014','01','18 + 31 = ?','Daniel Armaganian','209146943','49','10','49','-147.63','13');
...
-- Dump completed on 2023-05-28 14:46:44
