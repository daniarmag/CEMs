...
INSERT INTO `exam` VALUES (1,'01','01','01011',20,NULL,NULL,NULL,'315730176',NULL,NULL,NULL);
...
INSERT INTO `exam_question` VALUES ('01011','011',NULL);
...
INSERT INTO `question` VALUES (1,'01','011','1 + 1 = ?','Daniel Armaganian','209146943','2','1','2','3','4'),(2,'01','012','2 + 2 = ?','Matan Czuckermann','319003935','4','1','2','3','4'),(3,'02','023','What is the time complexity of merge sort algorithm?','Daniel Armaganian','209146943','O(nLogn)','O(Logn)','O(nLogn)','O(n^2)','O(n)'),(4,'01','014','18 + 31 = ?','Daniel Armaganian','209146943','49','10','49','-147.63','13');
...
INSERT INTO `question_course` VALUES ('011','01'),('014','01'),('011','02'),('014','02'),('023','03');
...
-- Dump completed on 2023-05-29 10:42:05
