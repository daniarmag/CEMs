...
INSERT INTO `question` VALUES ('001','01','01001','1 + 2 = ?','Daniel Armaganian','209146943','3','1','2','3','4'),('002','02','02002','What is the time complexity of merge sort algorithm?','Daniel Armaganian','209146943','O(nLogn)','O(Logn)','O(nLogn)','O(n^2)','O(n)'),('003','01','01003','solve for x:\n4x + 2 = 6\nx = ?','Daniel Armaganian','209146943','1','2','1','3','4');
...
CREATE TABLE `student_question` (
  ...
  CONSTRAINT `student_question_student_id` FOREIGN KEY (`student_id`) REFERENCES `student_course` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-30 21:52:24
