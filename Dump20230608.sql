...
CREATE TABLE `manual_exam` (
  ...
  `uploaded_file` blob,
  PRIMARY KEY (`exam_id`),
  CONSTRAINT `manual_exam_exam_id` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `manual_exam` VALUES ('010101',NULL,NULL);
...
-- Dump completed on 2023-06-08 11:43:35
